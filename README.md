# OID Allocator Technical Documentation
...
```sql
CREATE DATABASE oidallocator;
CREATE USER oidallocator WITH PASSWORD 'oidallocator';
GRANT ALL PRIVILEGES ON DATABASE oidallocator TO oidallocator;
```

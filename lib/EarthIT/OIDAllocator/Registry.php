...
class EarthIT_OIDAllocator_Registry
{
	...
	public function loadStorageHelper() {
		return new EarthIT_OIDAllocator_NormalStorageHelper($this);
	}
	...
	public function loadMailer() {
		...
		if( $recipientOverride = coalesce($transportConfig['recipient-override']) ) {
			$transport = new EarthIT_OIDAllocator_Email_RecipientOverrideTransport($transport, $recipientOverride);
		}

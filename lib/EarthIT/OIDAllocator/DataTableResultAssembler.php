...
class EarthIT_OIDAllocator_DataTableResultAssembler
...
implements EarthIT_CMIPREST_ResultAssembler
{
	...
	public function assembleResult( EarthIT_CMIPREST_ActionResult $result, TOGoS_Action $action=null, $ctx=null ) {
		...
		return EarthIT_OIDAllocator_PageAction_ShowDataTable::getInstance($this->registry, $result->getRootResourceClass(), $itemCols['root']);
	}

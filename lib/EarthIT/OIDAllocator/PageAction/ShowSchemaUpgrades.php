...
class EarthIT_OIDAllocator_PageAction_ShowSchemaUpgrades extends EarthIT_OIDAllocator_PageAction_TemplatePageAction
{
	protected $mode;
	
	public function __construct( EarthIT_OIDAllocator_Registry $reg, $mode='list' ) {

...
class EarthIT_OIDAllocator_PageAction_N2RPut extends EarthIT_OIDAllocator_PageAction
{
	protected $urn;
	protected $req;
	
	public function __construct( EarthIT_OIDAllocator_Registry $reg, $urn, EarthIT_OIDAllocator_Request $req ) {

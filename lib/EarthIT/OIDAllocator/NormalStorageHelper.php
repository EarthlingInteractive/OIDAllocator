...
class EarthIT_OIDAllocator_NormalStorageHelper
extends EarthIT_OIDAllocator_Component
implements EarthIT_OIDAllocator_StorageHelper, EarthIT_OIDAllocator_QueryHelper
{
	...
	protected function allocateEntityIds($count) {
		$this->entityIdPool = array_merge($this->entityIdPool, $this->queryValueSet(
			...
			"FROM generate_series(1,{count})", [
				'count'=>$count, 'seq'=>'public.newentityid'
			]));
	}
